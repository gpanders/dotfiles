...
fzf_colors["Eighties"]="bg+:#393939,bg:#2d2d2d,spinner:#66cccc,hl:#6699cc,fg:#a09f93,header:#6699cc,info:#ffcc66,pointer:#66cccc,marker:#66cccc,fg+:#e8e6df,prompt:#ffcc66,hl+:#6699cc"

export FZF_COLOR_SCHEME="Eighties"
